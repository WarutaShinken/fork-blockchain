...
If you want to learn more about this project, read the [wiki](https://github.com/Fork-Network/fork-blockchain/wiki), or check out the [green paper](https://www.forkcoin.net/assets/ForkGreenPaper.pdf).
