...
from fork.pools.pool_config import PoolWalletConfig
from fork.util.config import load_config, save_config, create_default_fork_config
...
def test_pool_config():
    ...
    create_default_fork_config(test_root, ["config.yaml"])
