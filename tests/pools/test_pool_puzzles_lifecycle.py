...
from fork.util.ints import uint64, uint32
...
from fork.wallet.puzzles.p2_conditions import puzzle_for_conditions
from fork.wallet.puzzles import singleton_top_layer
from fork.pools.pool_wallet_info import PoolState
from fork.pools.pool_puzzles import (
...
This test suite aims to test:
    - fork.pools.pool_puzzles.py
    - fork.wallet.puzzles.pool_member_innerpuz.clvm
    - fork.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("e14aedf3faa668c80c719d759f5bd3b5d84fff25ea54099937ba330203e6d2eb")
