...
required to run a [Timelord](https://github.com/Taco-Network/fork-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Taco-Network/fork-blockchain/blob/main/install-timelord.sh)
