...
required to run a [Timelord](https://github.com/Fork-Network/fork-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Fork-Network/fork-blockchain/blob/main/install-timelord.sh)
