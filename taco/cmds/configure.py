...
from fork.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.forknetwork.net"
            testnet = "testnet7"
            ...
            mainnet_port = "18620"
            mainnet_introducer = "dns-introducer.forknetwork.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running fork services for changes to take effect")
