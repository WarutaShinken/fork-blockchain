...
from fork.cmds.configure import configure_cmd
from fork.cmds.farm import farm_cmd
from fork.cmds.init import init_cmd
from fork.cmds.keys import keys_cmd
from fork.cmds.netspace import netspace_cmd
from fork.cmds.plots import plots_cmd
from fork.cmds.show import show_cmd
from fork.cmds.start import start_cmd
from fork.cmds.stop import stop_cmd
from fork.cmds.wallet import wallet_cmd
from fork.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage fork blockchain infrastructure ({__version__})\n",
    epilog="Try 'fork start node', 'fork netspace -d 192', or 'fork show -s'",
...
@cli.command("version", short_help="Show fork version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs fork daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from fork.daemon.server import async_run_daemon
    import asyncio
