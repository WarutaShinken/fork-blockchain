...
from fork.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "fork" in cc_discrepancies:
                    cc_discrepancies["fork"] = cc_discrepancies["fork"] + diff
                else:
                    cc_discrepancies["fork"] = diff
