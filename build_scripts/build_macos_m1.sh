...
electron-packager . Fork --asar.unpack="**/daemon/**" --platform=darwin \
...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Fork-darwin-arm64/Fork.app --platform=darwin \
...
mv Fork-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Fork-$FORK_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Fork-darwin-arm64/Fork.app Fork-$FORK_INSTALLER_VERSION-arm64 \
...
# xcrun altool --notarize-app -f Fork-0.1.X.dmg --primary-bundle-id net.fork.blockchain -u username -p password
...
# xcrun stapler staple Fork-0.1.X.dmg
#
# Validate DMG:
# xcrun stapler validate Fork-0.1.X.dmg
