...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Fork-darwin-x64/Fork.app --platform=darwin \
...
mv Fork-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Fork-$FORK_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Fork-darwin-x64/Fork.app Fork-$FORK_INSTALLER_VERSION \
